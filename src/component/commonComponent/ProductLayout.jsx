        ...
        <div className="flex flex-col gap-10">
          <div className=" flex justify-between items-end">
            ...
            <div className="flex justify-center items-center gap-2">
              <div className=" prev w-[46px] h-[46px] bg-f5f5f5 rounded-full flex justify-center items-center">
                {" "}
                <span>
                  <FaArrowLeft />
                </span>
              </div>
              <div className="next w-[46px] h-[46px] bg-f5f5f5 rounded-full flex justify-center items-center">
                {" "}
                <span>
                  <FaArrowRight />
                </span>
